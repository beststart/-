...
public class ZipUtil {
    ...
    public static void main(String[] args) throws Exception {
        unRar("D:\\OneDrive - RLS ,inc\\学校资料\\工程学院\\17嵌入式\\课程资料\\作业\\0306作业\\126778693_17612968_6620845\\20170507105-张敏\\张敏-17软嵌1-20170507105.rar","D:\\jieya");
    }
    ...
    public static void unZipFiles(String zipPath, String descDir) {
        ...
        try{
            ...
            if(FileUtil.getSuffix(zipFile.getName()).equals("rar")){
                unRar(zipPath,descDir);
            }else{
     ...
     * @return
     */
    public static boolean unRar(String rarFilePath, String destDir){
        ...
        String rarPath="\""+rarFile+"\"";//解决CMD命令中不能使用带空格的路径的问题，解决方式就是给地址两边加上双引号
        destDir="\""+destDir+"\"";
        String cmd = cmdPath + " X -o+ " + rarPath + " " + destDir;
        log.debug("cmd :{}", cmd);
        try {
